Here you will find the files to reproduce the ISRF of the MMA chemical evolution model (Millán-Irigoyen et. al. 2020) shown in Romero et al. (in prep), section 4.

-MMA_positions.txt contains the positions where the mean intensity output will be saved. This goes to the 'MeanIntensity_Positions' folder in 'input_data'
...
-Inside the 'stars' folder, you will find the stellar spectra of all regions in 'MMA_stars.dat'. The contents of this folder should me copied to 'star_sources' folder in 'input_data'.
...
> gas_params  = 'input_data/params/MMA_gas.dat'
> star_params = 'input_data/params/MMA_stars.dat'
> meanIntensity_positions = 'input_data/MeanIntensity_Positions/MMA_positions.txt'
